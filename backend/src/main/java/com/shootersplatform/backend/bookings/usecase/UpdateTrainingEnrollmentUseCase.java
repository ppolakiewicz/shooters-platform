...
public class UpdateTrainingEnrollmentUseCase {
    ...
    UpdateTrainingEnrollmentUseCase(TrainingEnrollmentService trainingEnrollments) {
    ...
    public TrainingEnrollment update(
        ...
        return trainingEnrollments.update(ownerId, enrollmentId, name, description, trainingLevel, location, capacity, cancellationDeadlineDays, durationMinutes);
    }
}
